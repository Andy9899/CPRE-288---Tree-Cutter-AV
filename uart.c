...
{
    char buffer[21] = "                    ";    // array of characters
    char temp[2];

    int x = 1; //number of characters
    const char *initial = data;
    ...
    while (*data != '\0')
    {
        ...
        if (x == 21 || *data == '\r')
        {
            ...
            lcd_clear();
            data = initial; // sets data back to OG address
